...
EPOXY_function GFX_Rect GFX_CreateRect(V2F size, V2F position);
EPOXY_function void GFX_SetRectTexture(GFX_Rect* rectangle, GFX_Texture2D texture);
EPOXY_function void GFX_SetRectColor(GFX_Rect* rectangle, V4F color);
EPOXY_function void GFX_DrawRect(GFX_Rect* rectangle, GFX_Renderer* renderer);
EPOXY_function void GFX_FlipRectUV(GFX_Rect* rectangle);
...
EPOXY_function GFX_Font GFX_CreateFont(const u8* font_path, i32 size);
EPOXY_function GFX_Text GFX_CreateText(u8* text, V2F pos, GFX_Font font);
EPOXY_function void GFX_DrawText(GFX_Text* text, GFX_Renderer* renderer);
